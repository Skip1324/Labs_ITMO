...
public class CommunicationManager {
     ...
     */
        ...
        public CommunicationManager(IOManager ioManager) throws SocketException, UnknownHostException {
            this.ioManager = ioManager;
            inputManager  = new ReceiveServer(new CommandManager(), new IOManager());
    }

        synchronized public <T> T asker(Function<String, T> function,
        ...
        synchronized public String askName() throws IOException{
            String name;
        ...
        synchronized public Coordinates askCoordinates() throws IOException{
            int coordinateX = 0;
        ...
        synchronized public long askArea() throws IOException {
            Long area;
            if (!inputManager.getStatusFile()) {
        ...
        synchronized public int askPopulation() throws IOException {
            Integer population;
            if (!inputManager.getStatusFile()) {
        ...
        synchronized public long askMetersAboveSeaLevel() throws IOException {
            long meters;
            if (!inputManager.getStatusFile()) {
        ...
        synchronized public Double askAgglomeration() throws IOException {
            Double aglo;
            if (!inputManager.getStatusFile()) {
        ...
        synchronized public Climate askClimate() throws IOException{
            Climate category;
            if (!inputManager.getStatusFile()) {
        ...
        synchronized public StandardOfLiving askStandard() throws IOException{
        ...
        synchronized public Human askGovernor() throws IOException{
            String nameG;
            if (!inputManager.getStatusFile()) {
                nameG = asker(arg -> arg,
                        arg -> ((String) arg).length() > 0,
        ...
        synchronized public City askCity() throws IOException{
            String name = askName();
