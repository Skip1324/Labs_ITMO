...
public class City implements Comparable<City>, Serializable {
    ...
    public City(Long id, String name, Coordinates coordinates, Date creationDate, Long area, Integer population, long metersAboveseaLevel, Double agglomeration, Climate climate, StandardOfLiving standardOfLiving, Human governor,int userId) throws IncorrectDataException {
        setId(id);
        setName(name);
        setCoordinates(coordinates);
        setCreationDate(creationDate);
    ...
    public String toString() throws NullPointerException {
        ...
        throw new NullPointerException("NullPointerException in City.toString(): some field is null");}
    }
    /**
