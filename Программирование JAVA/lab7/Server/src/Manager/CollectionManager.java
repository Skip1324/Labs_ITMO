...
public class CollectionManager {
    private volatile TreeMap<Integer, City> cityTreeMap;
    private volatile LocalDate date;
    private volatile TreeSet<Long> usedID;
    ...
    synchronized public String removeKeyElement(TreeMap<Integer, City> cityTreeMap, int val, User user) {
        ...
        return "Этот элемент вам не принадлежит или его не существует! ";
    ...
    public synchronized void clearCollection(User user) {
